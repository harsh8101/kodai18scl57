...
$ns bandwidth $bs1 $ms1 364Kb simplex
$ns bandwidth $ms2 $bs2 364Kb simplex
$ns bandwidth $bs2 $ms2 364Kb simplex
...
proc Finish {} {
    ...
    puts $sid
    puts $did
    exec /home/ise/ex56/getrc -s $sid -d $did -f 0 p6.tr |\
    /home/ise/ex56/raw2xg -s 0.01 -m 100 -r >> p6.xgr
    exec /home/ise/ex56/getrc -s $sid -d $did -f 0 p6.tr |\
    /home/ise/ex56/raw2xg -a -s 0.01 -m 100 >> p6.xgr
    exec ./p6.awk p6.xgr
    exec xgraph -bb -tk -nl -m -x time -y packet p6.xgr &
    exit 0
}
